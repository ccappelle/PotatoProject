...
class PYROSIM:
	...
	def Send_Box(self, ID=0, x=0, y=0, z=0, collision=1,length=0.1, width=0.1, height=0.1, r=1, g=1, b=1):
		...
		outputString = outputString + ' ' + str(ID)
                ...
                outputString = outputString + ' ' + str(collision)
        ...
        def Send_Cylinder(self, ID=0, x=0, y=0, z=0, collision=1,r1=0, r2=0, r3=1, length=1.0, radius=0.1, r=1, g=1, b=1):
